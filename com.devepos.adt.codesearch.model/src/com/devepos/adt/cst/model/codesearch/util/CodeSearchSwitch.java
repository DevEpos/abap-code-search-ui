...
public class CodeSearchSwitch<T> extends Switch<T> {
   ...
   * '<em>Object</em>'. <!-- begin-user-doc --> This implementation returns null;
  ...
  /**
   * Returns the result of interpreting the object as an instance of
   * '<em>Match</em>'. <!-- begin-user-doc --> This implementation returns null;
   * returning a non-null result will terminate the switch. <!-- end-user-doc -->
   *
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of
  ...
  /**
   * Returns the result of interpreting the object as an instance of
   * '<em>Result</em>'. <!-- begin-user-doc --> This implementation returns null;
   * returning a non-null result will terminate the switch. <!-- end-user-doc -->
   *
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of
  ...
  /**
   * Returns the result of interpreting the object as an instance of
   * '<em>Settings</em>'. <!-- begin-user-doc --> This implementation returns
