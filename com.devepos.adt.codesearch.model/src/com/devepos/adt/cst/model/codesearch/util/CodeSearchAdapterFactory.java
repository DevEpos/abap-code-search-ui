...
public class CodeSearchAdapterFactory extends AdapterFactoryImpl {
   ...
   * <em>Object</em>}'. <!-- begin-user-doc --> This default implementation
   ...
   * <em>Match</em>}'. <!-- begin-user-doc --> This default implementation returns
   ...
   * <em>Settings</em>}'. <!-- begin-user-doc --> This default implementation
   * returns null so that we can easily ignore cases; it's useful to ignore a case
   * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
   *
   * @return the new adapter.
